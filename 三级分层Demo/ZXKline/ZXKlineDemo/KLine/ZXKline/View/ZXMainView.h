 ...
 * 峰值
 */
@property (nonatomic,assign) double quotaVolMinAssert;
/**
 *低值
 */
@property (nonatomic,assign) double quotaVolMaxAssert;
/**
 *单位价格的高度值
 */
 ...
 *单位价格的高度值
 */
@property (nonatomic,assign) CGFloat quotaVolHeightPerPoint;
