 ...
 */
#define TotalHeight (Portrait ? ((ZX_IS_IPHONE_X?((KSCREEN_HEIGHT-44-40-49-34)-(102+40+41+20+6)*HeightScale):(KSCREEN_HEIGHT-64-49))) : KSCREEN_WIDTH)
...
#define QuotaChartHeightKlineWithQuota   (Portrait ? (PortraitChartHeight/6.0*1) : (LandScapeChartHeight/6.0*1))
...
//新增一级高度
#define NewQuotaHeight   (Portrait ? (PortraitChartHeight/6.0*1) : (LandScapeChartHeight/6.0*1))
//成对修改
#define MiddleQuotaType PresetQuotaNameWithVOL
#define MiddleQuotaName @"VOL"
